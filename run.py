...
def get_last_5_entries_sales():
    """ Collect collumns of data for the sales worksheet, collecting the last 5 entries for each sandwich and returns the data as a list of lists. """
...
def calculate_stock_data(data):
    """ Calculate the average stock for each item type adds 10% """
...
print("Welcome to Love Sanswiches Data Automation")
main()